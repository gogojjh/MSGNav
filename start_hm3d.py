...
def main(scene_id, device_id, start_ratio=0.0, end_ratio=1.0):  
    ...
    os.system(f'CUDA_VISIBLE_DEVICES={device_id} python run_iin_evaluation.py -cf cfg/eval_mp3d.yaml --start_ratio {start_ratio} --end_ratio {end_ratio} --specific {scene_id}') 
