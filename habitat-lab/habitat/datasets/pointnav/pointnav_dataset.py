...
class PointNavDatasetV1(Dataset):
    ...
    def __init__(self, config: Optional[Config] = None) -> None:
        ...
        if has_individual_scene_files:
            ...
            for scene in scenes[config.SPLIT_L:config.SPLIT_R]:  # modified by someone
        ...
        #     if i==0 or self.episodes[i].scene_id != self.episodes[i-1].scene_id:
        #         print(i, self.episodes[i].scene_id)
        # exit()
