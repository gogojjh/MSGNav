...
from src.conceptgraph.utils.logging_metrics import DenoisingTracker
import cv2
import os
...
from src.conceptgraph.utils.vis import OnlineObjectRenderer, save_video_from_frames
...
def main(cfg: DictConfig):
    ...
    det_exp_path = get_exp_out_path(
        cfg.dataset_root, cfg.scene_id, cfg.detections_exp_suffix
    )
